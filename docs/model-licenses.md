...
| `nvidia/parakeet-tdt-0.6b-v3` (en / es shipping path) | `CC-BY-4.0` | <https://huggingface.co/nvidia/parakeet-tdt-0.6b-v3> (model-card YAML: `license: cc-by-4.0`) | <https://creativecommons.org/licenses/by/4.0/legalcode.en> |
| `istupakov/parakeet-tdt-0.6b-v3-onnx` (ONNX INT8 mirror — what `scripts/setup_parakeet_v3.sh` downloads) | `CC-BY-4.0` (inherited) | <https://huggingface.co/istupakov/parakeet-tdt-0.6b-v3-onnx> (model-card YAML: `license: cc-by-4.0`) | <https://creativecommons.org/licenses/by/4.0/legalcode.en> |
...
| `reazon-research/reazonspeech-k2-v2` (Zipformer; Japanese shipping path) | `Apache-2.0` | <https://huggingface.co/reazon-research/reazonspeech-k2-v2> (model-card YAML: `license: apache-2.0`) | <https://www.apache.org/licenses/LICENSE-2.0.txt> |
| `sherpa-onnx-zipformer-ja-en-reazonspeech-2025-01-17` (INT8 export — what `scripts/setup_reazon_ja.sh` downloads) | `Apache-2.0` (inherited) | <https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models> (export of the above) | <https://www.apache.org/licenses/LICENSE-2.0.txt> |
...
| `DataoceanAI/Dolphin` | `Apache-2.0` | <https://github.com/DataoceanAI/Dolphin> ("Dolphin's code and model weights are released under the Apache 2.0 License") | <https://www.apache.org/licenses/LICENSE-2.0.txt> |
| `csukuangfj/sherpa-onnx-dolphin-small-ctc-multi-lang-int8-2025-04-02` (CTC ONNX export — what `scripts/setup_dolphin_ko.sh` downloads) | `Apache-2.0` (inherited) | <https://huggingface.co/csukuangfj/sherpa-onnx-dolphin-small-ctc-multi-lang-int8-2025-04-02> (model-card YAML: `license: apache-2.0`; "This model is converted from https://github.com/DataoceanAI/Dolphin"). Byte-identical to the [sherpa-onnx GitHub release](https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models) archive we used to unpack — same publisher, same SHA-256, but the licence is declared per artefact instead of inside the tarball | <https://www.apache.org/licenses/LICENSE-2.0.txt> |
