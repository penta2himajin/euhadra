...
| `sherpa-onnx-dolphin-small-ctc-multi-lang-int8-2025-04-02` (CTC ONNX export — what `scripts/setup_dolphin_ko.sh` downloads) | `Apache-2.0` (inherited) | <https://github.com/k2-fsa/sherpa-onnx/releases/tag/asr-models> — the archive's own `README.md` carries the model-card frontmatter `license: apache-2.0` and states "This model is converted from https://github.com/DataoceanAI/Dolphin" | <https://www.apache.org/licenses/LICENSE-2.0.txt> |
